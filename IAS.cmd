...
::
::   Homepages: https://github.com/IhfazAlam
::        
::
::      
::
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Created by TechTrendz"
echo:            ___________________________________________________ 
echo:
echo:               YouTube: https://www.youtube.com/@TechTrendzXYZ
echo:               Github: https://github.com/IhfazAlam
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Activate
echo:               [2] Freeze Trial
